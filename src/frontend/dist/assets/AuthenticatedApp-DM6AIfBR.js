...
import { S as Subscribable, s as shallowEqualObjects, h as hashKey, g as getDefaultState, n as notifyManager, u as useQueryClient, r as reactExports, a as noop$1, b as shouldThrowError, c as createLucideIcon, j as jsxRuntimeExports, R as React$1, d as reactDomExports, e as React$2, v as vt, f as useActor, i as useInternetIdentity, k as useQuery, E as ExternalBlob, L as LoaderCircle, C as Cloud } from "./index-DGA9ZM7O.js";
...
const FileArchive = createLucideIcon("file-archive", __iconNode$o);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const FileAudio = createLucideIcon("file-audio", __iconNode$n);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const FileVideo = createLucideIcon("file-video", __iconNode$j);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const File = createLucideIcon("file", __iconNode$i);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const FolderInput = createLucideIcon("folder-input", __iconNode$h);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const FolderPlus = createLucideIcon("folder-plus", __iconNode$f);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const HardDrive = createLucideIcon("hard-drive", __iconNode$c);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const LayoutList = createLucideIcon("layout-list", __iconNode$9);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
var ve = (n) => {
  ...
  let { invert: e, toast: t, unstyled: a, interacting: u, setHeights: f, visibleToasts: w, heights: S, index: g, toasts: i, expanded: D, removeToast: T, defaultRichColors: F, closeButton: et, style: ut, cancelButtonStyle: ft, actionButtonStyle: l, className: ot = "", descriptionClassName: at = "", duration: X2, position: st, gap: pt, loadingIcon: rt, expandByDefault: B, classNames: s, icons: P, closeButtonAriaLabel: nt = "Close toast", pauseWhenPageIsHidden: it } = n, [Y, C] = React$2.useState(null), [lt, J] = React$2.useState(null), [W, H] = React$2.useState(false), [A, mt] = React$2.useState(false), [L, z] = React$2.useState(false), [ct, d] = React$2.useState(false), [h, y] = React$2.useState(false), [R, j] = React$2.useState(0), [p, _] = React$2.useState(0), O = React$2.useRef(t.duration || X2 || Wt), G = React$2.useRef(null), k = React$2.useRef(null), Vt = g === 0, Ut = g + 1 <= w, N = t.type, V = t.dismissible !== false, Kt = t.className || "", Xt = t.descriptionClassName || "", dt = React$2.useMemo(() => S.findIndex((r2) => r2.toastId === t.id) || 0, [S, t.id]), Jt = React$2.useMemo(() => {
    var r2;
    return (r2 = t.closeButton) != null ? r2 : et;
  }, [t.closeButton, et]), Tt = React$2.useMemo(() => t.duration || X2 || Wt, [t.duration, X2]), gt = React$2.useRef(0), U = React$2.useRef(0), St = React$2.useRef(0), K = React$2.useRef(null), [Gt, Qt] = st.split("-"), Rt = React$2.useMemo(() => S.reduce((r2, m, c) => c >= dt ? r2 : r2 + m.height, 0), [S, dt]), Et = Ft(), qt = t.invert || e, ht = N === "loading";
  U.current = React$2.useMemo(() => dt * pt + Rt, [dt, Rt]), React$2.useEffect(() => {
    O.current = Tt;
...
function useGetAllFolders() {
  const { actor, isFetching } = useActor();
  const { identity } = useInternetIdentity();
  return useQuery({
    queryKey: ["folders", identity == null ? void 0 : identity.getPrincipal().toString()],
    queryFn: async () => {
      if (!actor) return [];
...
function useGetFolderContents(folderId) {
  const { actor, isFetching } = useActor();
  const { identity } = useInternetIdentity();
  return useQuery({
    queryKey: [
      "folderContents",
      (folderId == null ? void 0 : folderId.toString()) ?? null,
...
function useGetFolderPath(folderId) {
  const { actor, isFetching } = useActor();
  const { identity } = useInternetIdentity();
  return useQuery({
    queryKey: [
  ...
  return useMutation({
    ...
    onSuccess: (_, variables) => {
      ...
      queryClient.invalidateQueries({
        queryKey: [
          "folderContents",
          ((_a2 = variables.parentId) == null ? void 0 : _a2.toString()) ?? null,
          identity == null ? void 0 : identity.getPrincipal().toString()
        ]
      });
    }
...
function useGetAllFiles() {
  ...
  const { identity } = useInternetIdentity();
  return useQuery({
    queryKey: ["files", identity == null ? void 0 : identity.getPrincipal().toString()],
    queryFn: async () => {
      if (!actor) return [];
  ...
  return useMutation({
    ...
    onSuccess: (_, variables) => {
      ...
      queryClient.invalidateQueries({
        queryKey: [
          "folderContents",
          ((_a2 = variables.folderId) == null ? void 0 : _a2.toString()) ?? null,
          identity == null ? void 0 : identity.getPrincipal().toString()
        ]
      });
      queryClient.invalidateQueries({ queryKey: ["filesInFolder"] });
      queryClient.invalidateQueries({
        queryKey: ["tags", identity == null ? void 0 : identity.getPrincipal().toString()]
      });
    }
  });
}
...
function useSearchFilesWithTags(searchTerm, tagIds) {
  const { actor, isFetching } = useActor();
  const { identity } = useInternetIdentity();
...
function useFileUpload(currentFolderId, onUploadComplete) {
  ...
  const handleFiles = reactExports.useCallback(
    async (files) => {
      ...
      for (const file of fileArray) {
        const toastId = ue.loading(`Uploading ${file.name}...`);
        try {
          ...
          ue.success(`${file.name} uploaded`, { id: toastId });
        } catch (error) {
          console.error("Upload error:", error);
          ue.error(`Failed to upload ${file.name}`, { id: toastId });
        }
      }
  ...
  const triggerUpload = reactExports.useCallback(() => {
    var _a2;
    if (isUploading) return;
    (_a2 = inputRef.current) == null ? void 0 : _a2.click();
  }, [isUploading]);
  const FileInput = reactExports.useCallback(
    () => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "input",
      {
        ref: inputRef,
...
function fromNanoseconds(timestamp) {
  return fromUnixTime(Number(timestamp) / 1e9);
}
...
async function downloadFile(file) {
  const toastId = ue.loading(`Preparing ${file.name}...`);
  try {
    ...
    ue.success("Download started", { id: toastId });
  } catch (_error) {
    ue.error("Failed to download file", { id: toastId });
  }
}
function buildFolderPathMap(folders, rootFolderId) {
...
async function downloadFolderAsZip(rootFolderId, rootFolderName, files, allFolders, onProgress) {
  if (files.length === 0) {
...
function getTagNames(tagIds, tags) {
  return tagIds.map((id) => {
    var _a2;
    return (_a2 = tags.find((t) => t.id === id)) == null ? void 0 : _a2.name;
  }).filter((name) => name !== void 0).join("; ");
}
function exportMetadataAsCSV({
  ...
  try {
    ...
    link.href = url;
    link.download = `folderly-export-${format(/* @__PURE__ */ new Date(), "yyyy-MM-dd")}.csv`;
...
function Breadcrumb({ path, onNavigate }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Breadcrumb$1, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(BreadcrumbList, { className: "flex-nowrap overflow-x-auto", children: [
    ...
    reversedPath.map((folder, index2) => {
      const isLast = index2 === reversedPath.length - 1;
      return /* @__PURE__ */ jsxRuntimeExports.jsxs(BreadcrumbItem, { className: "shrink-0", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(BreadcrumbSeparator, {}),
        isLast ? /* @__PURE__ */ jsxRuntimeExports.jsx(BreadcrumbPage, { children: folder.name }) : /* @__PURE__ */ jsxRuntimeExports.jsx(
          BreadcrumbLink,
          {
            href: "#",
            onClick: (e) => {
...
function CreateFolderDialog({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open, onOpenChange: handleOpenChange, children: /* @__PURE__ */ jsxRuntimeExports.jsx(DialogContent, { className: "sm:max-w-md", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogHeader, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { children: "New Folder" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogDescription, { children: "Create a new folder to organize your files." })
    ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { className: "gap-2", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { type: "submit", disabled: !name.trim() || isPending, children: [
...
function useDownloadFile() {
  const [downloadingFileId, setDownloadingFileId] = reactExports.useState(
    null
  );
...
function TagManagementDialog({
  ...
  const [showNewTagForm, setShowNewTagForm] = reactExports.useState(false);
  ...
  const handleSaveEdit = async () => {
    ...
    try {
      ...
      ue.success("Tag updated");
      cancelEditing();
    } catch {
      ue.error("Failed to update tag");
    }
  };
  const handleDelete = async () => {
    ...
    try {
      ...
      ue.success("Tag deleted");
    } catch {
      ue.error("Failed to delete tag");
    } finally {
      setTagToDelete(null);
    }
  };
  const handleCreateTag = async () => {
    ...
    try {
      ...
      ue.success("Tag created");
      setNewTagName("");
      setNewTagColor(TAG_COLORS[0]);
      setShowNewTagForm(false);
    } catch {
      ue.error("Failed to create tag");
    }
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Dialog, { open, onOpenChange, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { className: "sm:max-w-lg", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogHeader, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { children: "Manage Tags" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(DialogDescription, { children: "Create, edit, and organize your tags. Changes apply to all files." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 py-4", children: [
        showNewTagForm ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border border-border rounded-lg p-3 space-y-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                ...
                children: isCreating ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "h-4 w-4 animate-spin" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { className: "h-4 w-4" })
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-1.5", children: TAG_COLORS.map((color) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
              onClick: () => setNewTagColor(color),
              className: `w-6 h-6 rounded-full transition-all ${newTagColor === color ? "ring-2 ring-offset-2 ring-primary" : ""}`,
        ...
        isError ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-destructive py-4 text-center", children: "Failed to load tags. Please refresh." }) : isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center py-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "h-6 w-6 animate-spin text-muted-foreground" }) }) : tags.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-center text-muted-foreground py-8", children: "No tags yet. Create one to get started." }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ScrollArea, { className: "h-[300px]", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: tags.map((tag) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: "flex items-center gap-3 p-2 rounded-lg border border-border hover:bg-muted/50",
            children: editingTag === tag.id ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 space-y-2", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-1.5", children: TAG_COLORS.map((color) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    ...
                    className: `w-5 h-5 rounded-full transition-all ${editColor === color ? "ring-2 ring-offset-1 ring-primary" : ""}`,
                    style: { backgroundColor: color }
                  },
                  color
                )) })
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Button,
                {
                  ...
                  children: isUpdating ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "h-4 w-4 animate-spin" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { className: "h-4 w-4" })
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Button,
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "flex-1 text-sm font-medium truncate", children: tag.name }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Button,
                {
                  size: "icon",
      ...
      AlertDialog,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogContent, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogHeader, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialogTitle, { children: "Delete tag?" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogDescription, { children: [
              'Are you sure you want to delete "',
              tagToDelete == null ? void 0 : tagToDelete.name,
...
function EditFileDialog({
  ...
  const selectedTags = selectedTagIds.map((id) => allTags.find((t) => t.id === id)).filter((t) => t !== void 0);
  const availableTags = allTags.filter((t) => !selectedTagIds.includes(t.id));
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open, onOpenChange: handleOpenChange, children: /* @__PURE__ */ jsxRuntimeExports.jsx(DialogContent, { className: "sm:max-w-md", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogHeader, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { children: "Edit File" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(DialogDescription, { children: "Update file name, description, and tags." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-4 py-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "file-name", children: "Name" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Input,
            {
              id: "file-name",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "file-description", children: "Description" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Textarea,
            {
              id: "file-description",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-2", children: [
          ...
          isTagsError && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-destructive text-sm", children: "Failed to load tags." }),
          selectedTags.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-1.5", children: selectedTags.map((tag) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Badge,
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                ...
                children: isCreatingTag ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "h-4 w-4 animate-spin" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Plus, { className: "h-4 w-4" })
              }
            )
          ] }),
          availableTags.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-1.5", children: availableTags.filter(
            (t) => !newTagName || t.name.toLowerCase().includes(newTagName.toLowerCase())
          ).slice(0, 10).map((tag) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Badge,
            {
              variant: "outline",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { className: "gap-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { type: "submit", disabled: !name.trim() || isPending, children: [
          isUpdating && /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "h-4 w-4 animate-spin" }),
...
function FilePreviewDialog({
    ...
    const loadPreview = async () => {
      ...
      try {
        if (file.fileType.startsWith("image/")) {
          ...
          setPreviewUrl(url);
        } else if (file.fileType.startsWith("text/") || file.fileType === "application/json" || file.fileType === "application/javascript" || file.fileType === "application/xml") {
          const bytes = await file.blob.getBytes();
          const text = new TextDecoder().decode(bytes);
          setTextContent(text.slice(0, 5e4));
        }
      } catch (error) {
        console.error("Preview error:", error);
        ue.error("Failed to load preview");
      } finally {
        setIsLoading(false);
      }
    };
  ...
  const fileTags = (file == null ? void 0 : file.tagIds.map((id) => allTags.find((t) => t.id === id)).filter((t) => t !== void 0)) ?? [];
  const isImage2 = file == null ? void 0 : file.fileType.startsWith("image/");
  (file == null ? void 0 : file.fileType.startsWith("text/")) || (file == null ? void 0 : file.fileType) === "application/json" || (file == null ? void 0 : file.fileType) === "application/javascript" || (file == null ? void 0 : file.fileType) === "application/xml";
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open, onOpenChange, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    DialogContent,
    {
      className: `w-[95vw] ${isImage2 ? "sm:max-w-3xl" : "sm:max-w-2xl"} max-h-[90vh] flex flex-col`,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(DialogHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { className: "truncate pr-8", children: file == null ? void 0 : file.name }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 overflow-hidden flex flex-col gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center gap-3 text-sm text-muted-foreground", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: file ? formatFileSize(file.size) : "" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Calendar, { className: "h-3.5 w-3.5" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: file ? formatDate(file.uploadDate, true) : "" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs bg-muted px-2 py-0.5 rounded", children: file == null ? void 0 : file.fileType })
          ] }),
          isTagsError ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground text-sm", children: "Tags unavailable" }) : fileTags.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-1.5", children: fileTags.map((tag) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            Badge,
            {
              style: { backgroundColor: tag.color, color: "#fff" },
              className: "text-xs",
          ...
          (file == null ? void 0 : file.description) && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: file.description }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 min-h-0 border border-border rounded-lg overflow-hidden bg-muted/30", children: isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-64 w-full" }) }) : previewUrl ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center p-4 h-full", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "img",
            {
              src: previewUrl,
          ...
          ) }) : textContent ? /* @__PURE__ */ jsxRuntimeExports.jsx(ScrollArea, { className: "h-[50vh]", children: /* @__PURE__ */ jsxRuntimeExports.jsx("pre", { className: "p-4 text-xs font-mono whitespace-pre-wrap break-words", children: textContent }) }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-center h-64 text-muted-foreground", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(File, { className: "h-16 w-16 mb-4 opacity-50" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm", children: "Preview not available for this file type" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs mt-1", children: "Download the file to view its contents" })
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Button,
            {
              ...
              children: [
                isDownloading ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "h-4 w-4 animate-spin" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Download, { className: "h-4 w-4" }),
...
function MoveFileDialog({
  ...
  const buildFolderTree = (parentId) => {
    return allFolders.filter((f) => (f.parentId ?? null) === parentId).sort((a, b) => a.name.localeCompare(b.name));
  };
  const FolderItem = ({
    folder,
    depth = 0
    ...
    const isCurrent = (file == null ? void 0 : file.folderId) === folder.id;
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          children: [
            ...
            isCurrent && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs opacity-70", children: "(current)" })
          ]
        }
      ),
      children.map((child) => /* @__PURE__ */ jsxRuntimeExports.jsx(FolderItem, { folder: child, depth: depth + 1 }, child.id))
    ] });
  };
  const rootFolders = buildFolderTree(null);
  const isRootSelected = selectedFolderId === null;
  const isCurrentRoot = !(file == null ? void 0 : file.folderId);
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open, onOpenChange: handleOpenChange, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { className: "sm:max-w-md", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogHeader, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { children: "Move File" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "py-4", children: [
      isFoldersError ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-destructive py-4 text-center", children: "Failed to load folders. Please refresh." }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border border-border rounded-lg", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(ScrollArea, { className: "h-[300px]", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            type: "button",
            ...
            className: `
                  ...
                  `,
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(House, { className: "h-4 w-4 shrink-0" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "flex-1", children: "Root (no folder)" }),
              isCurrentRoot && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs opacity-70", children: "(current)" })
            ]
          }
        ),
        rootFolders.map((folder) => /* @__PURE__ */ jsxRuntimeExports.jsx(FolderItem, { folder }, folder.id)),
        rootFolders.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-3 py-4 text-sm text-muted-foreground text-center", children: "No folders yet" })
      ] }) }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { className: "gap-2", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { onClick: handleSubmit, disabled: isPending, children: [
        isPending && /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "h-4 w-4 animate-spin" }),
...
function MoveFolderDialog({
  ...
  const { data: allFolders = [], isError: isFoldersError } = useGetAllFolders();
  const invalidIds = folder ? /* @__PURE__ */ new Set([folder.id, ...getDescendantIds(folder.id, allFolders)]) : /* @__PURE__ */ new Set();
  reactExports.useEffect(() => {
    if (folder) {
  ...
  const buildFolderTree = (parentId) => {
    return allFolders.filter((f) => (f.parentId ?? null) === parentId && !invalidIds.has(f.id)).sort((a, b) => a.name.localeCompare(b.name));
  };
  const FolderItem = ({
    folderItem,
    depth = 0
    ...
    const isCurrent = (folder == null ? void 0 : folder.parentId) === folderItem.id;
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Folder, { className: "h-4 w-4 shrink-0" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "truncate flex-1", children: folderItem.name }),
            isCurrent && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs opacity-70", children: "(current)" })
          ]
        }
      ),
      children.map((child) => /* @__PURE__ */ jsxRuntimeExports.jsx(FolderItem, { folderItem: child, depth: depth + 1 }, child.id))
    ] });
  };
  const rootFolders = buildFolderTree(null);
  const isRootSelected = selectedFolderId === null;
  const isCurrentRoot = !(folder == null ? void 0 : folder.parentId);
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open, onOpenChange: handleOpenChange, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { className: "sm:max-w-md", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogHeader, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { children: "Move Folder" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogDescription, { children: [
        'Select a destination for "',
        folder == null ? void 0 : folder.name,
        '".'
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "py-4", children: [
      isFoldersError ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-destructive py-4 text-center", children: "Failed to load folders. Please refresh." }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border border-border rounded-lg", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(ScrollArea, { className: "h-[300px]", children: [
        ...
        rootFolders.map((folderItem) => /* @__PURE__ */ jsxRuntimeExports.jsx(FolderItem, { folderItem }, folderItem.id)),
        rootFolders.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-3 py-4 text-sm text-muted-foreground text-center", children: "No valid destinations" })
      ] }) }),
      error && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-destructive mt-2", children: error })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { className: "gap-2", children: [
...
function RenameFolderDialog({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open, onOpenChange: handleOpenChange, children: /* @__PURE__ */ jsxRuntimeExports.jsx(DialogContent, { className: "sm:max-w-md", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogHeader, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { children: "Rename Folder" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogDescription, { children: "Enter a new name for this folder." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-4 py-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "folder-name", children: "Folder name" }),
...
function FileList({
  ...
  const [folderToDelete, setFolderToDelete] = reactExports.useState(null);
  const [fileToEdit, setFileToEdit] = reactExports.useState(null);
  const [folderToRename, setFolderToRename] = reactExports.useState(null);
  const [fileToMove, setFileToMove] = reactExports.useState(null);
  const [folderToMove, setFolderToMove] = reactExports.useState(null);
  const [fileToPreview, setFileToPreview] = reactExports.useState(null);
  const [sortField, setSortField] = reactExports.useState("name");
  const [sortOrder, setSortOrder] = reactExports.useState("asc");
  const [downloadingFolder, setDownloadingFolder] = reactExports.useState(
    null
  );
  const [internalViewMode, setInternalViewMode] = reactExports.useState("list");
  const { download: handleDownloadFile, downloadingFileId } = useDownloadFile();
  const lastTapTimeRef = reactExports.useRef(0);
  const handleDoubleTap = (callback) => (e) => {
    const now = Date.now();
  ...
  const { mutateAsync: deleteFolder, isPending: isDeletingFolder } = useDeleteFolder();
  const { actor } = useActor();
  const { data: allFolders = [], isError: isFoldersError } = useGetAllFolders();
  const { data: allTags = [], isError: isTagsError } = useGetAllTags();
  ...
  const handleDeleteFile = async () => {
    ...
    try {
      ...
      ue.success("File deleted successfully");
      if ((selectedFile == null ? void 0 : selectedFile.id) === fileToDelete.id) {
        onSelectFile(null);
      }
    } catch (_error) {
  ...
  const handleDownloadFolder = reactExports.useCallback(
    async (folder) => {
      ...
      const toastId = ue.loading(`Preparing ${folder.name}.zip...`);
      try {
        const files2 = await actor.getAllFilesInFolder(folder.id);
        if (files2.length === 0) {
          ue.dismiss(toastId);
          ue.error("Folder is empty");
        ...
        ue.dismiss(toastId);
        ue.success(`${folder.name}.zip downloaded`);
      } catch (error) {
        ue.dismiss(toastId);
        ue.error("Failed to download folder");
  ...
  const sortedFiles = [...files].sort((a, b) => {
    ...
    if (sortField === "name") {
      ...
      const aFirstTag = ((_a2 = allTags.find((t) => a.tagIds.includes(t.id))) == null ? void 0 : _a2.name) || "";
      const bFirstTag = ((_b = allTags.find((t) => b.tagIds.includes(t.id))) == null ? void 0 : _b.name) || "";
  ...
  if (isFoldersError || isTagsError) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-destructive p-4", children: "Failed to load data. Please refresh." });
  }
  if (isLoading) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4 space-y-3", children: ["s1", "s2", "s3", "s4", "s5"].map((sk) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4", children: [
  ...
  if (folders.length === 0 && files.length === 0) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-12 text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "inline-flex p-4 rounded-full bg-muted/50 mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(FolderOpen, { className: "h-8 w-8 text-muted-foreground" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg font-medium mb-2", children: "This folder is empty" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Upload files or create folders to get started" })
    ] });
  }
  const SortIcon = ({ field }) => {
    if (sortField !== field) {
      return /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronsUpDown, { className: "h-4 w-4 text-muted-foreground/50" });
    }
    return sortOrder === "asc" ? /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronUp, { className: "h-4 w-4" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronDown, { className: "h-4 w-4" });
  };
  const ViewToggleHeader = () => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between p-3 border-b border-border bg-muted/30", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-2", children: viewMode === "grid" && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Select,
        {
          value: sortField,
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { className: "w-[120px] h-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, { placeholder: "Sort by" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "type", children: "Type" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Button,
        {
          ...
          className: "h-8 px-2",
          children: sortOrder === "asc" ? /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronUp, { className: "h-4 w-4" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronDown, { className: "h-4 w-4" })
        }
      )
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      ToggleGroup,
      {
        ...
        size: "sm",
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(ToggleGroupItem, { value: "list", "aria-label": "List view", children: /* @__PURE__ */ jsxRuntimeExports.jsx(LayoutList, { className: "h-4 w-4" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(ToggleGroupItem, { value: "grid", "aria-label": "Grid view", children: /* @__PURE__ */ jsxRuntimeExports.jsx(LayoutGrid, { className: "h-4 w-4" }) })
        ]
      }
    )
  ] });
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(ViewToggleHeader, {}),
    viewMode === "grid" ? (
      // Grid view
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-4", children: [
        sortedFolders.map((folder) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenu, { children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenuContent, { align: "end", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenuItem, { onClick: () => onOpenFolder(folder.id), children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    DropdownMenuItem,
                    {
                      ...
                      children: [
                        downloadingFolder === folder.id ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "h-4 w-4 animate-spin" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Download, { className: "h-4 w-4" }),
                        "Download as ZIP"
                      ]
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenuItem, { onClick: () => setFolderToRename(folder), children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Pencil, { className: "h-4 w-4" }),
                    "Rename"
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenuItem, { onClick: () => setFolderToMove(folder), children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(FolderInput, { className: "h-4 w-4" }),
                    "Move"
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    DropdownMenuItem,
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-3 rounded-lg bg-primary/10 border border-primary/20 mb-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Folder, { className: "h-8 w-8 text-primary" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium text-center truncate w-full", children: folder.name }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Folder" })
            ]
          },
          `folder-${folder.id}`
        )),
        sortedFiles.map((file) => {
          const Icon2 = getFileIcon(file.fileType);
          const isSelected = (selectedFile == null ? void 0 : selectedFile.id) === file.id;
          const isImage2 = file.fileType.startsWith("image/");
          return /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              className: `group relative flex flex-col items-center p-4 rounded-lg border cursor-pointer transition-all ${isSelected ? "border-primary bg-primary/10" : "border-border/50 hover:border-primary/50 hover:bg-muted/50"}`,
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenu, { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    DropdownMenuTrigger,
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenuContent, { align: "end", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      DropdownMenuItem,
                      {
                        ...
                        children: [
                          downloadingFileId === file.id ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "h-4 w-4 animate-spin" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Download, { className: "h-4 w-4" }),
                          "Download"
                        ]
                      }
                    ),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenuItem, { onClick: () => setFileToEdit(file), children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(Pencil, { className: "h-4 w-4" }),
                      "Edit"
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenuItem, { onClick: () => setFileToMove(file), children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(FolderInput, { className: "h-4 w-4" }),
                      "Move"
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                ...
                isImage2 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full h-20 mb-2 rounded overflow-hidden bg-muted/50 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "img",
                  {
                ...
                ) }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-3 rounded-lg bg-muted/50 border border-border/50 mb-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { className: "h-8 w-8 text-muted-foreground" }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium text-center truncate w-full", children: file.name }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: formatFileSize(file.size) }),
                file.tagIds.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-1 mt-1 justify-center", children: [
                  ...
                  file.tagIds.length > 2 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    Badge,
                    {
                      variant: "outline",
                      className: "text-[10px] px-1.5 py-0",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Table, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(TableHeader, { className: "bg-muted/30", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            TableHead,
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            TableHead,
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1", children: [
                "Size",
                /* @__PURE__ */ jsxRuntimeExports.jsx(SortIcon, { field: "size" })
              ] })
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            TableHead,
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1", children: [
                "Type",
                /* @__PURE__ */ jsxRuntimeExports.jsx(SortIcon, { field: "type" })
              ] })
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            TableHead,
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1", children: [
                "Tags",
                /* @__PURE__ */ jsxRuntimeExports.jsx(SortIcon, { field: "tag" })
              ] })
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: "p-3 w-12" })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(TableBody, { children: [
          sortedFolders.map((folder) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            TableRow,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "p-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-2 rounded-lg bg-primary/10 border border-primary/20", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Folder, { className: "h-4 w-4 text-primary" }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0 flex-1", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-medium truncate text-sm", children: folder.name }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground md:hidden", children: "Folder" })
                  ] })
                ] }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "p-3 text-sm text-muted-foreground hidden md:table-cell", children: "—" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "p-3 text-sm text-muted-foreground hidden lg:table-cell", children: formatDate(folder.createdDate) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "p-3 text-sm text-muted-foreground hidden lg:table-cell", children: "Folder" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "p-3 hidden xl:table-cell", children: "—" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "p-3 text-right", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenu, { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    DropdownMenuTrigger,
                    {
                      asChild: true,
                      onClick: (e) => e.stopPropagation(),
                      children: /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "ghost", size: "icon", className: "h-8 w-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx(EllipsisVertical, { className: "h-4 w-4" }) })
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenuContent, { align: "end", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenuItem, { onClick: () => onOpenFolder(folder.id), children: [
          ...
          sortedFiles.map((file) => {
            ...
            return /* @__PURE__ */ jsxRuntimeExports.jsxs(
              TableRow,
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "p-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-2 rounded-lg bg-muted/50 border border-border/50", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { className: "h-4 w-4 text-muted-foreground" }) }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0 flex-1", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-medium truncate text-sm", children: file.name }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground md:hidden", children: formatFileSize(file.size) })
                    ] })
                  ] }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "p-3 text-sm text-muted-foreground hidden md:table-cell", children: formatFileSize(file.size) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "p-3 text-sm text-muted-foreground hidden lg:table-cell", children: formatDate(file.uploadDate) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "p-3 text-sm text-muted-foreground hidden lg:table-cell", children: file.fileType }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "p-3 hidden xl:table-cell", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-1", children: [
                    ...
                    file.tagIds.length > 3 && /* @__PURE__ */ jsxRuntimeExports.jsxs(Badge, { variant: "outline", className: "text-xs", children: [
                      "+",
      ...
      AlertDialog,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogContent, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogHeader, { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogDescription, { children: [
              'Are you sure you want to delete "',
              fileToDelete == null ? void 0 : fileToDelete.name,
              '"? This action cannot be undone.'
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogFooter, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialogCancel, { disabled: isDeletingFile, children: "Cancel" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              AlertDialogAction,
              {
                onClick: (e) => {
                ...
                className: "bg-destructive text-destructive-foreground hover:bg-destructive/90",
                children: [
                  isDeletingFile && /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "mr-2 h-4 w-4 animate-spin" }),
      ...
      AlertDialog,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogContent, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogHeader, { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogDescription, { children: [
              'Are you sure you want to delete "',
              folderToDelete == null ? void 0 : folderToDelete.name,
              '"? This will permanently delete the folder and all its contents.'
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogFooter, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialogCancel, { disabled: isDeletingFolder, children: "Cancel" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              AlertDialogAction,
              {
                onClick: (e) => {
                ...
                className: "bg-destructive text-destructive-foreground hover:bg-destructive/90",
                children: [
                  isDeletingFolder && /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "mr-2 h-4 w-4 animate-spin" }),
...
function EditNameDialog({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open, onOpenChange, children: /* @__PURE__ */ jsxRuntimeExports.jsx(DialogContent, { className: "sm:max-w-md", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogHeader, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { children: "Edit Name" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogDescription, { children: "Update your display name." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-4 py-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-2", children: [
...
function Header({ userName }) {
  ...
  const [editNameDialogOpen, setEditNameDialogOpen] = reactExports.useState(false);
  const [tagManagementOpen, setTagManagementOpen] = reactExports.useState(false);
  const handleLogout = () => {
    queryClient.clear();
    clear();
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "bg-card border-b border-border px-4 py-3 flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-7 h-7 rounded-lg bg-gradient-to-br from-blue-500 to-violet-600 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Cloud, { className: "w-3.5 h-3.5 text-white" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-lg font-bold tracking-tight font-display text-foreground", children: "ICcloud" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenu, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(DropdownMenuTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          Button,
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(Avatar, { className: "h-9 w-9 cursor-pointer", children: /* @__PURE__ */ jsxRuntimeExports.jsx(AvatarFallback, { className: "bg-primary text-primary-foreground text-sm", children: userName.charAt(0).toUpperCase() }) })
          }
        ) }),
...
function ProfileSetupDialog({ open }) {
  const [name, setName] = reactExports.useState("");
  const [error, setError] = reactExports.useState(null);
  const { mutate: setProfile, isPending } = useSetProfile();
  const handleSubmit = (e) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open, children: /* @__PURE__ */ jsxRuntimeExports.jsx(DialogContent, { showCloseButton: false, className: "sm:max-w-md", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogHeader, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { children: "Welcome to ICcloud!" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogDescription, { children: "Let's set up your profile. Enter your name to get started." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-4 py-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-2", children: [
...
function AuthenticatedApp() {
  ...
  const isFiltering = debouncedSearchQuery.trim() !== "" || selectedTagIds.length > 0;
  const {
    data: filteredResults,
    isLoading: isSearching,
    isError: isSearchError
  } = useSearchFilesWithTags(debouncedSearchQuery, selectedTagIds);
  const hasProfile = profile == null ? void 0 : profile.name;
  const displayedFiles = isFiltering ? filteredResults ?? [] : (folderContents == null ? void 0 : folderContents.files) ?? [];
  const displayedFolders = isFiltering ? [] : (folderContents == null ? void 0 : folderContents.folders) ?? [];
  ...
  const handleExportCSV = () => {
    try {
      ...
      ue.success("Metadata exported as CSV");
    } catch (error) {
      ue.error(
  ...
  const hasDataError = isProfileError || isContentsError || isTagsError || isFilesError || isFoldersError;
  if (hasDataError) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen flex items-center justify-center bg-background", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-destructive text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Failed to load data. Please refresh." }) }) });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(ProfileSetupDialog, { open: !hasProfile }),
    hasProfile && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background flex flex-col", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Header, { userName: profile.name }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "flex-1 p-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center gap-2 mb-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-full sm:flex-1 sm:max-w-md", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(DropdownMenuTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Button,
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden sm:inline", children: "Tags" }),
                  selectedTagIds.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "secondary", className: "ml-1 h-5 px-1.5", children: selectedTagIds.length })
                ]
              }
            ) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenuContent, { align: "start", className: "w-48", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(DropdownMenuLabel, { children: "Filter by Tag" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(DropdownMenuSeparator, {}),
              allTags.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-2 py-3 text-sm text-muted-foreground text-center", children: "No tags yet" }) : allTags.map((tag) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenu, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(DropdownMenuTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { className: "gap-2", "data-ocid": "toolbar.primary_button", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Plus, { className: "h-4 w-4" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden sm:inline", children: "New" })
            ] }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenuContent, { align: "end", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenuItem, { onClick: () => setShowCreateFolder(true), children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(FolderPlus, { className: "h-4 w-4" }),
                "New Folder"
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenuItem, { onClick: triggerUpload, children: [
        ...
        isFiltering && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-4 flex-wrap", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-muted-foreground", children: "Filtering:" }),
          searchQuery && /* @__PURE__ */ jsxRuntimeExports.jsxs(Badge, { variant: "secondary", className: "gap-1", children: [
            'Search: "',
            searchQuery,
            '"',
            /* @__PURE__ */ jsxRuntimeExports.jsx(
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-4 overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Breadcrumb, { path: folderPath, onNavigate: handleNavigate }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(FileInput, {}),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-card border border-border rounded-lg overflow-hidden", children: isSearchError ? /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: "text-destructive p-4 text-center",
            "data-ocid": "files.error_state",
            children: "Failed to search files. Please try again."
          }
        ) : /* @__PURE__ */ jsxRuntimeExports.jsx(
          FileList,
          {
